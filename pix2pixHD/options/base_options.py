...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='douyin_768p', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='-1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='pix2pixHD/checkpoints', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/01_gaudilnfill/')
